...
module.exports = class FreeSearchController {
	static async Search(req, res) {
		const destinationTemplate =
			'{"name":"..", "address": "..","why_should_i_go_there": ".."}';
		...
		prompt = `Is the following text asking for recommendations "${query}"? Return "true/"false"}`;
		...
		prompt = `Give top five recommendations related to travel dining or entertainment based on the following text "${query}", and return JSON array, for example: [${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}]
`;
