...
module.exports = class FreeSearchController {
	static async Search(req, res) {
		...
		prompt = `Give top five recommendations related to travel and leisure based on the following text "${query}", for example: [${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}, ${destinationTemplate}]
`;
